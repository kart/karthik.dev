    ...
    <div class="site-container">
        <nav class="main-nav">
            ...
            <div style="display:flex; gap:32px;">
                <a href="/" style="text-decoration:none; color:var(--text-muted); font-size:0.9rem; font-weight:500;">Home</a>
                <a href="/about" style="text-decoration:none; color:var(--text-muted); font-size:0.9rem; font-weight:500;">About</a>
            </div>
        </nav>
